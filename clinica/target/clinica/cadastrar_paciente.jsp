...
<head>
    ...
    <title>Cadastrar Paciente - Clínica</title>
...
<body>
    ...
    <div class="content fade-in">
        <div class="page-header">
            ...
            <p>Preencha os dados do novo paciente</p>
        </div>
        
        <form action="${pageContext.request.contextPath}/pacientes" method="post" class="form-container">
